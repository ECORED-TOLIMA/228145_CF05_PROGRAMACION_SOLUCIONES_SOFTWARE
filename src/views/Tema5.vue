...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4
      .col.col-lg-5.col-8.col-md-6.order-lg-2.order-1.mb-lg-0.mb-3.d-none.d-lg-block
        figure
      ...
      .col.col-lg-7.col-12.order-lg-1.order-2
        ...
        .cajon.cajon.C07.color-secundario.p-4.mb-4
    ...
    p.mb-4(data-aos="fade-down") A continuación, se presentan los elementos fundamentales de la programación modular:
      ...
      .col.col-12
        ...
        .tabla-a.color-acento-contenido
          table
            thead
              tr
                th(data-aos="fade-down")(style= "width: 30%; background-color: #FFEEBC;") Elemento
                th(data-aos="fade-down")(style= "width: 35%; background-color: #FFEEBC;") Descripción
    ...
    .row.justify-content-center.align-items-center.mb-0.bloque-c07-ajuste
    ...
    .row.justify-content-center.align-items-stretch.mb-4.g-0.recurso-c10-ajuste
      .col-lg-7.col-12.order-lg-2.order-2
        .cajon.C10.p-4.h-100.w-100
          p.mb-4 Las características de los módulos según su funcionalidad permiten definir cómo se organizan, interactúan y cumplen su propósito dentro de un programa. Estas características garantizan que cada módulo aporte de manera específica a la solución general, facilitando la claridad, el orden y la eficiencia en el desarrollo de algoritmos.
          .row.mb-0
          ...
          .row(numero="1" titulo="Identificar la función del módulo")
            .col-12.mb-4.mb-md-0
              ul.lista-ul.mb-0
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Determinar la tarea específica que debe cumplir.
                li
                  i.lista-ul__vineta
                  p.mb-0 Delimitar su responsabilidad dentro del algoritmo.
          .row(numero="2" titulo="Definir entradas y salidas")
            .col-12.mb-4.mb-md-0
              ul.lista-ul.mb-0
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Establecer los datos que recibe el módulo.
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Determinar la información que entrega como resultado.
          .row(numero="3" titulo="Diseñar la lógica interna")
            .col-12.mb-4.mb-md-0
              ul.lista-ul.mb-0
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Estructurar las instrucciones necesarias para cumplir su función.
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Garantizar coherencia y simplicidad en su desarrollo.
          .row(numero="4" titulo="Validar funcionamiento del módulo")
            .col-12.mb-4.mb-md-0
              ul.lista-ul.mb-0
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Verificar que cumple correctamente su propósito.
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Probar su comportamiento con diferentes datos.
          .row(numero="4" titulo="Integrar con otros módulos")
            .col-12.mb-4.mb-md-0
              ul.lista-ul.mb-0
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Asegurar la correcta comunicación entre módulos.
                li.mb-0
                  i.lista-ul__vineta
                  p.mb-0 Validar su interacción dentro del sistema completo.
      .col-lg-4.col-sm-4.col-5.order-lg-2.order-1.mb-lg-0.mb-4.d-none.d-lg-block
        figure
          img(src='@/assets/curso/tema5/img09v.png', alt='')
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col.col-lg-1.col-6.col-md-4.order-lg-1.order-1.mb-lg-0.mb-3.d-none.d-lg-block
        figure
      ...
      .col.col-12.col-lg-12
        .row.align-items-center.mb-4(data-aos="flip-down")
          ...
          .col-lg-auto.col-9.titulo01(style="z-index:1")
            .p-2
              h3.mb-0.ms-2 Clasificación de errores en algoritmos
          ...
          .col.col-12
            ...
            .tabla-a.color-acento-contenido
              table
                thead
                  tr
                    th(data-aos="fade-down")(style= "width: 30%; background-color: #FFEEBC;") Tipo de error
                    th(data-aos="fade-down")(style= "width: 35%; background-color: #FFEEBC;") Descripción
                    th(data-aos="fade-down")(style= "width: 35%; background-color: #FFEEBC;") Ejemplo
                tbody
                  tr
        ...
        PasosA.color-primario(tipo="n")
          .row.justify-content-center
            ...
            .col-lg-5.col-12.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-up")
              img(src='@/assets/curso/tema5/img15.jpg', alt="")          
          .row.justify-content-center
            .col-lg-5.col-12.mb-lg-0.mb-4(data-aos="fade-up")
              img(src='@/assets/curso/tema5/img16.jpg', alt="")          
          ...
          .row.justify-content-center
            ...
            .col-lg-5.col-12.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-up")
              img(src='@/assets/curso/tema5/img17.jpg', alt="")
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="flip-up")
      SlyderF.color-acento-botones(columnas="col-lg-6 col-xl-4")
        ...
        .tarjeta.tarjeta--C11.p-4
          .row.justify-content-center.mb-3
            .col-lg-6.col-sm-4.col-6
              img(src='@/assets/curso/tema5/img20.svg' alt='')
        ...
        .tarjeta.tarjeta--C11.p-4
          .row.justify-content-center.mb-3
            .col-lg-6.col-sm-4.col-6
              img(src='@/assets/curso/tema5/img21.svg' alt='')
    ...
    .row.justify-content-center.mb-0
      .col.col-12
        p.mb-4(data-aos="fade-down") Una vez definidos los parámetros, es importante establecer cómo se gestionan dentro del programa, considerando el siguiente proceso:
    .BG06.BG06-cols6.px-md-5.p-lg-0.p-4.mb-4
      .row.justify-content-center.align-items-end.my-0.BG06-row
        .col-lg-4.col-md-8.col-sm-6.mb-md-4.mb-sm-4.desktop
          figure(data-aos="zoom-in")
            img(src="@/assets/curso/tema5/img23.png", alt="alt")
        .col-lg-8 
          SlyderF.custom.color-acento-botones(columnas="col-lg-6 col-xl-6")
            .tarjeta.bgslyder2.p-4
              .row.justify-content-center.mb-3
                .col-5
                  img(src="@/assets/curso/tema5/img24.svg", alt="alt")
              p.text-center Identificación de los datos requeridos por el módulo y establecimiento de los valores iniciales.
            .tarjeta.bgslyder2.p-4
              .row.justify-content-center.mb-3
                .col-5
                  img(src="@/assets/curso/tema5/img25.svg", alt="alt")
              p.text-center Ejecución de las instrucciones del módulo y transformación de los datos de entrada.
            .tarjeta.bgslyder2.p-4
              .row.justify-content-center.mb-3
                .col-5
                  img(src="@/assets/curso/tema5/img26.svg", alt="alt")
              p.text-center Obtención de resultados a partir del procesamiento y preparación de los datos para ser retornados.
            .tarjeta.bgslyder2.p-4
              .row.justify-content-center.mb-3
                .col-5
                  img(src="@/assets/curso/tema5/img28.svg", alt="alt")
              p.text-center Envío de resultados al módulo principal u otros módulos y continuidad del flujo del programa.
        ...
        .tarjeta--container.row
            ...
            .row.justify-content-center.mb-3
              .col-lg-7.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema5/img31.svg', alt='')(style="width: 85%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C13.p-5
            .row.justify-content-center.mb-3
              .col-lg-7.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema5/img32.svg', alt='')(style="width: 85%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C14.p-5
            .row.justify-content-center.mb-3
              .col-lg-7.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema5/img33.svg', alt='')(style="width: 85%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C15.p-5
            .row.justify-content-center.mb-3
              .col-lg-7.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema5/img34.svg', alt='')(style="width: 85%")
