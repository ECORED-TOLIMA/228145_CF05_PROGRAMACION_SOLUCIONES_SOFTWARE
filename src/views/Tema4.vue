  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.tarjeta--C04.px-5.py-3
            .p-4
              ...
              br
    .row.justify-content-center.align-items-center.mb-0.bloque-c07-ajuste.bloque-c07-sin-img-responsive
        ...
        .tarjeta--container.row
            ...
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema4/img09.svg', alt='')(style="width: 85%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C13.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema4/img10.svg', alt='')(style="width: 85%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C14.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema4/img11.svg', alt='')(style="width: 85%")
    ...
    .row.justify-content-center.mb-4
      .col.col-lg-5.col-8.col-md-6.order-lg-2.order-1.mb-lg-0.mb-3.d-none.d-lg-block
        figure
          img(src='@/assets/curso/tema4/img16.svg', alt='')
      .col.col-lg-7.col-12.order-lg-1.order-2
        ...
        .cajon.cajon.C07.color-secundario.p-4.mb-4
          p.mb-0(data-aos="fade-down") Su aplicación es fundamental cuando se requiere procesar datos de forma continua, realizar cálculos repetitivos o recorrer conjuntos de información. A través de estructuras como <em>for</em> y <em>while</em>, el algoritmo puede controlar la cantidad de veces que se ejecuta un bloque de instrucciones, garantizando precisión en el resultado.
    ...
    .row.BG04.justify-content-center.px-md-5.px-4.mb-4
      ...
      .col-lg-4.col-sm-4.col-5.order-lg-1.order-1.mb-lg-0.mb-4.d-none.d-lg-block
        figure
          img(src='@/assets/curso/tema4/img17v.png', alt='')
    .row.justify-content-center.mb-0
      .col.col-lg-10.col-12
        .cajon.cajon.C02.px-4.py-3
    ...
    .row.justify-content-center.mb-4
      .col.col-lg-5.col-8.col-md-6.order-lg-1.order-1.mb-lg-0.mb-3.d-none.d-lg-block
        figure
          img(src='@/assets/curso/tema4/img18.png', alt='')
      .col.col-lg-7.col-12.order-lg-2.order-2
        ...
        PasosB.color-acento-botones 
          .row.justify-content-center.p-4(titulo="")
            ...
            .col-lg-6.col-10.order-lg-1.order-1.mb-lg-0.mb-4
              figure
                img(src='@/assets/curso/tema4/img19.jpg', alt='')
          .row.justify-content-center.p-4(titulo="")
            .col-lg-6.order-lg-2.order-2
              h4 Ingreso de datos
            ...
            .col-lg-6.col-10.order-lg-1.order-1.mb-lg-0.mb-4
              figure
                img(src='@/assets/curso/tema4/img20.jpg', alt='')
          .row.justify-content-center.p-4(titulo="")
            .col-lg-6.order-lg-2.order-2
            ...
            .col-lg-6.col-10.order-lg-1.order-1.mb-lg-0.mb-4
              figure
                img(src='@/assets/curso/tema4/img21.jpg', alt='')
          .row.justify-content-center.p-4(titulo="")
            .col-lg-6.order-lg-2.order-2
            ...
            .col-lg-6.col-10.order-lg-1.order-1.mb-lg-0.mb-4
              figure
                img(src='@/assets/curso/tema4/img22.jpg', alt='')
    .row.justify-content-center.mb-0
      .col.col-lg-10.col-12
        .cajon.cajon.C02.px-4.py-3
