  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .tarjeta--container.row
            ...
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema3/img10.svg', alt='')(style="width: 85%")
            h4.text-center Identificadores
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta--C05.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure(data-aos="fade-up")
                  img(src='@/assets/curso/tema3/img11.svg', alt='')(style="width: 85%")
            h4.text-center Palabras reservadas
    ...
    .row.BG04.justify-content-center.px-md-5.px-4.mb-4
      ...
      .col-lg-4.col-sm-4.col-5.order-lg-2.order-1.mb-lg-0.mb-4.d-none.d-lg-block
        figure
          img(src='@/assets/curso/tema3/img12v.png', alt='')
    ...
    .row.justify-content-center.mb-4
      ...
      .col.col-lg-8.col-12.order-lg-2.order-2
        ...
        .cajon.cajon.C01.color-secundario.p-4.mb-4
    ...
    p.mb-4 Para su correcta aplicación, se requiere considerar las siguientes características:
    .row.justify-content-center.mb-4(data-aos="flip-up")
      .col.col-12
    ...
    .row.justify-content-center.mb-4
      .col.col-lg-6.col-8.col-md-6.order-lg-2.order-1.mb-lg-0.mb-3.d-none.d-lg-block
        figure
          ...
          .col.col-12
            ...
            .tabla-a.color-acento-contenido
              table
                thead
                  tr
                    th(data-aos="fade-down")(style= "width: 30%; background-color: #FFEEBC;") Tipo de dato
                    th(data-aos="fade-down")(style= "width: 35%; background-color: #FFEEBC;") Descripción
                    th(data-aos="fade-down")(style= "width: 35%; background-color: #FFEEBC;") Ejemplo
                tbody
                  tr
