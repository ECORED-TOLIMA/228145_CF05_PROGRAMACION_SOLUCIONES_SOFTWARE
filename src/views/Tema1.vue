...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-0
      .col.col-lg-10.col-12
        .cajon.cajon.C07.color-secundario.px-4.py-3
          .row.mb-0
    ...
    .row.justify-content-center.mb-4
      .col.col-lg-4.col-8.col-md-6.order-lg-1.order-1.mb-3.mb-lg-0.d-none.d-lg-block
        figure
      ...
      .col.col-lg-8.col-12.order-lg-2.order-2
        ...
        .cajon.cajon.C08.color-primario.px-4.py-3
    ...
    .row.justify-content-center.mb-0
      ...
      .col-xl-4.col-lg-4.col-md-10.col-12.mb-xl-0
        .crd_hover_txt.mb-4(data-aos="flip-left")(@mouseover="mostrarIndicador = true")
          ...
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/tema1/img40.jpg", alt="")
          .crd_hover_txt--body
      ...
      .col-xl-4.col-lg-4.col-md-10.col-12.mb-xl-0
        .crd_hover_txt.mb-4(data-aos="flip-left")(@mouseover="mostrarIndicador = true")
          ...
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/tema1/img41.jpg", alt="")
          .crd_hover_txt--body
